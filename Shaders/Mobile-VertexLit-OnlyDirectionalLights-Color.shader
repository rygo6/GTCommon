// Same as built-in Mobile/VertexLit (Only Directional Lights) but adds a Color multiply channel.
...
Shader "GeoTetra/Mobile/VertexLit Color (Only Directional Lights)" {
    Properties {
